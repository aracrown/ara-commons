...
public final class Exceptions {
	...
	/**
	 * Checks {@code throwable} for a cause of type {@code class1}. Throws cause exception if found.
	 *
	 * @param throwable exception to check for cause type
	 * @param class1    cause type to check
	 * @param <X>       exception type to be re-thrown
	 * @throws X exception thrown if cause type was found in chain
	 */
